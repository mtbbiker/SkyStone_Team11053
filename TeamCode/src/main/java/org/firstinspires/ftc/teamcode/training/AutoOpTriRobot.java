...
@Autonomous(name="3.Eugene Comp", group="Exercises")
//@Disabled
public class AutoOpTriRobot extends LinearOpMode {
    ...
    public void init(HardwareMap amasterConfig) {
        ...
        motorLeftFront = masterConfig.get(DcMotor.class, "leftmotor");
        motorRightFront = masterConfig.get(DcMotor.class, "rightmotor");
